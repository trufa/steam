...
'<img border="0" align="absmiddle" style="margin-top:-6px;cursor:pointer;" src="'+star+'">'+
'<img border="0" align="absmiddle" style="margin-top:-6px;cursor:pointer;" src="'+star+'" '+
'onclick="javascript:window.open(\'https://marketplace.atlassian.com/apps/1211413/draw-io-diagrams-for-jira?hosting%3Dserver%26tab%3Dreviews\');">';var basicAds=['<a title="'+mxResources.get('loveIt',['draw.io'])+
'" target="_blank" href="https://twitter.com/intent/tweet?text='+
